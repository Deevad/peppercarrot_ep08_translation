...
* Romvel Cyr by Alexander Samburov, [link](http://www.lurex.narod.ru/alex/fonts/fonts.html), license is unknown but according to author's site, fonts can be downloaded for free.
...
- Do not edit or propose a commit for the artwork in these repositories. Artwork here are low-resolution proxy files only. The real hi-res layered artwork,  *.kra files, are [available here] www.peppercarrot.com/static6/sources.e artwork in these repositories. Artwork here are low-resolution proxy files only. The real hi-res layered artwork,  *.kra files, are [available here] www.peppercarrot.com/static6/sources